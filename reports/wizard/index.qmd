...
if (params$population == "eur") {
  overview_fig_data <- fread("data/EUR_plot_data.csv") ## TODO: check if relative paths work in the actual application
}
...
## create a custom table container (e.g. for gene Table)
