...
import genepi.r2web.commands.ServerCommand;
...
public class App implements Runnable {
	...
	public static final String NAME = "r2web";
	...
	public static final String CONFIG_FILENAME = "r2web.yaml";
