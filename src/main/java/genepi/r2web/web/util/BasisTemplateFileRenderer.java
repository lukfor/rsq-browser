...
import genepi.r2web.web.util.functions.DecimalFunction;
import genepi.r2web.web.util.functions.DoubleFormatFunction;
import genepi.r2web.web.util.functions.IncludeScriptFunction;
import genepi.r2web.web.util.functions.IncludeStyleFunction;
import genepi.r2web.web.util.functions.IsRouteActiveFunction;
import genepi.r2web.web.util.functions.PercentageFunction;
import genepi.r2web.web.util.functions.RouteFunction;
import genepi.r2web.web.util.functions.ToJsonFunction;
